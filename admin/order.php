...
$orders = mysqli_query($conn, "SELECT * FROM detailorder WHERE orderid='$orderids'");
...
if (isset($_POST['selesai'])) {
	$updatecartstatus = mysqli_query($conn, "UPDATE cart set status='Selesai' WHERE orderid='$orderids'");
...
<head>
	...
	<title>Sinardunia - Pesanan <?= $checkdb['namalengkap']; ?></title>
					...
					<div class="col-12">
						<div class="card">
							<div class="card-body">
								...
								<p><?= $checkdb['namalengkap']; ?> (<?= $checkdb['alamat']; ?>)</p>
