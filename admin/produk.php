...
<body>
	...
	<div class="page-container">
		...
		<div class="main-content">
			...
			<?php
			if (@$_GET['p'] == 'delete') {
				mysqli_query($conn, "DELETE FROM produk WHERE idproduk='" . $_GET['id'] . "' ");
				echo '<script>window.location="produk.php"</script>';
			}
			if (@$_GET['p'] == 'edit') {
				$produk = mysqli_query($conn, "SELECT * FROM produk WHERE idproduk='" . $_GET['id'] . "'") or die(mysqli_error($conn)());
								...
								<div class="card-body">
									...
									<div>
										<form action="produk.php" method="post" enctype="multipart/form-data">
											...
											<input name="idproduk" type="hidden" class="form-control" value="<?= $produk['idproduk'] ?>">
											...
											<div class="form-group">
												...
												<input name="rate" type="number" class="form-control" min="1" max="5" required value="<?= $produk['rate'] ?>">
											</div>
											<div class="form-group">
												<label>Harga Sebelum Diskon</label>
												<input name="hargabefore" type="number" class="form-control" value="<?= $produk['hargabefore'] ?>">
											</div>
											<div class="form-group">
												<label>Harga Setelah Diskon</label>
												<input name="hargaafter" type="number" class="form-control" value="<?= $produk['hargaafter'] ?>">
											</div>
											<div class="form-group">
												<label>Stok</label>
												<input name="stok" type="number" class="form-control" value="<?= $produk['stok'] ?>">
											</div>
											<div class="form-group">
												<label>Gambar</label>
