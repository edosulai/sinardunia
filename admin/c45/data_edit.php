                            ...
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                                    ...
                                    <form method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input type="text" name="nama_barang" required="required" class="form-control" value="<?php echo $data['nama_barang'] ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input type="text" name="x1" required="required" class="form-control" value="<?php echo $data['x1'] ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input type="text" name="x2" required="required" class="form-control" value="<?php echo $data['x2'] ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <input type="text" name="x3" required="required" class="form-control" value="<?php echo $data['x3'] ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 ">
                                                <select name="x4" id="" required="required" class="form-control">
                                                    <option value="besar" <?= $data['x4'] == 'besar' ? 'selected' : '' ?>>besar</option>
                                                    <option value="kecil" <?= $data['x4'] == 'kecil' ? 'selected' : '' ?>>kecil</option>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    if (isset($_POST['simpan'])) {
                                        ...
                                        $update = $koneksi->query("UPDATE tb_data SET nama_barang = '$nama_barang', x1 = '$x1', x2 = '$x2', x3 = '$x3', x4 = '$x4', keputusan = '$keputusan' WHERE id_data = '$id' ");
