<div class="right_col" role="main">
    <div class="">
        ...
        $alldata = $koneksi->query("SELECT * FROM tb_data")->fetch_assoc();

        $total = $koneksi->query("SELECT COUNT(*) AS total FROM tb_data ")->fetch_assoc();
        $laris = $koneksi->query("SELECT COUNT(*) AS laris FROM tb_data WHERE keputusan = 'Laris' ")->fetch_assoc();
        $kuranglaris = $koneksi->query("SELECT COUNT(*) AS kuranglaris FROM tb_data WHERE keputusan = 'Kurang Laris' ")->fetch_assoc();
