...
<body>
	...
	<div class="login">
		<div class="container">
			<h2>Selamat Datang Di Sinar Dunia</h2>
			...
			<div>
				<h4>Mau jadi member??</h4>
				<p><a href="registered.php">Belum punya akun? daftar di sini !</a></p>
			</div>
			<!-- <div>
				<h4>Lupa password?</h4>
				<p><a href="lupa.php">Reset Password</a></p>
			</div> -->
		</div>
	</div>
