...
<head>
	<title>Sinardunia - Checkout</title>
...
<body>
	...
	<div class="checkout">
		<div class="container">
			<h1 >Terima kasih, <?= $_SESSION['name'] ?> telah membeli <?= $itungtrans3 ?> barang di Sinardunia</span></h1>
		...
		<div class="checkout-left">
			<div class="checkout-left-basket">
				...
				<ul>
					...
					<h1><input type="text" value="Rp<?= number_format($subtotal) ?>" disabled \></h1>
				</ul>
			</div>
			<br>
			<div class="checkout-left-basket" style="width:80%;margin-top:60px;">
				<div class="checkout-left-basket">
					...
					<h1><input type="text" value="<?= $orderidd ?>" disabled \></h1>
				</div>
			</div>
