...
<body>
	...
	<div class="top-brands">
		<div class="container">
			<h2>Sinar Dunia Condet</h2>
			<div class="grid_3 grid_5">
				<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
					<div id="myTabContent" class="tab-content">
						<div role="tabpanel" class="tab-pane fade in active" id="expeditions" aria-labelledby="expeditions-tab">
							<div class="agile-tp row justify-content-between">
								<h5 class="col-md-6">Penawaran Terbaik Minggu Ini
									<?php
								...
								<div class="agile_top_brands_grids">
									...
									<?php
									if (@$_GET['v'] == 'desc') {
										$brgs = mysqli_query($conn, "SELECT * FROM produk ORDER BY hargaafter DESC");
									} else if (@$_GET['v'] == 'asc') {
										$brgs = mysqli_query($conn, "SELECT * FROM produk ORDER BY hargaafter ASC");
									} else {
														...
														<figure>
															<div class="snipcart-item block">
																<div class="snipcart-thumb">
																	<a href="product.php?idproduk=<?= $p['idproduk'] ?>"><img title=" " alt=" " src="<?= $p['gambar'] ?>" width="200px" height="200px" /></a>
																	<p><?= $p['namaproduk'] ?></p>
																	<!-- <div class="stars">
																	<?php
